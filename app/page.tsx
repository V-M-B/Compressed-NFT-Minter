    ...
    return (
        <main className='min-h-screen flex items-center justify-center p-4'>
            <div className='w-full max-w-4xl'>
                <form onSubmit={event => mintCompressedNft(event)} className='rounded-lg min-h-content bg-[#2a302f] p-4'>
                    <div className='flex justify-between items-center'>
                        ...
                        <button
                            type='submit'
                            className='!bg-[#3e28b6] !rounded-lg py-1 sm:py-2 px-4 font-semibold transition-all duration-200 border-2 border-transparent hover:border-[#FF8C00] hover:bg-transparent disabled:opacity-50 disabled:hover:bg-[#FF8C00] disabled:cursor-not-allowed'
                        >
                            Mint
                        </button>
                    </div>
